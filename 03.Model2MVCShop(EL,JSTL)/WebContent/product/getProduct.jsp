...
<table class="table">
	...
	<tr>
		...
		<td class="ct_write01">
			<img src = "/images/uploadFiles/../../images/empty.GIF" alt="${product.getFileName()}"/>
		</td>
	</tr>
	<tr>
		<td width="104" class="ct_write">
			...
			<tr>
				<td>
					<c:if test='${param.menu!="soldout"}'>
						<button class="btn btn-default" onclick="/listProuct.do?prod_no=${product.getProdNo()}">구매</button>
					</c:if>
